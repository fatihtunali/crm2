...
import TourPackageFilters from '@/components/tour-packages/TourPackageFilters';
import TourPackageTable from '@/components/tour-packages/TourPackageTable';
import ViewTourPackageModal from '@/components/tour-packages/ViewTourPackageModal';
import NewTourPackageModal from '@/components/tour-packages/NewTourPackageModal';
import EditTourPackageModal from '@/components/tour-packages/EditTourPackageModal';
import ManagePricingModal from '@/components/tour-packages/ManagePricingModal';
...
export default function TourPackagesPage() {
  ...
  async function confirmDelete() {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error('Failed to archive tour package');
      }
